...
AS $$
DECLARE
  project_url TEXT := 'https://bhgxbfqeuadlyitsuwqr.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJoZ3hiZnFldWFkbHlpdHN1d3FyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwOTcwODEzNSwiZXhwIjoyMDI1Mjg0MTM1fQ.RTalK_FTCWfgdzK861L4vqgtGokTl5mZeTkF7U4Y14o'; -- full access needed for http request to storage
